...
if (typeof TILE_TYPES === 'undefined' || typeof DAMAGE_TYPES === 'undefined' || typeof QUEST_STATUS === 'undefined') {
    console.error("config_enums.js - ERREUR: TILE_TYPES, DAMAGE_TYPES ou QUEST_STATUS n'est pas défini !");
}